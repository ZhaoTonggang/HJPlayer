...
! function(e, t) {
	"object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define &&
		define
		.amd ? define("hjplayer", [], t) : "object" == typeof exports ? exports.hjplayer = t() : e.hjplayer = t()
	...
	return function(e) {
				...
				a = {
					...
					setScrollPosition: function(e) {
						var t = e.left,
							...
							i = e.top,
							a = void 0 === i ? 0 : i;
						this.isFirefox ? (document.documentElement.scrollLeft = n, document
							.documentElement.scrollTop = a) : window.scrollTo(
							n, a)
					},
					isMobile: i,
		...
		function(e, t, n) {
			...
			e.exports = function(e) {
				...
				var t = "",
					...
					u = e.url,
					n = a && "webvtt" === a.type;
				return t += '\n<video\n    class="hjplayer-video ', o && (t +=
						"hjplayer-video-current"), t +=
					'"\n    webkit-playsinline\n    playsinline\n    ', s && (t += 'poster="', t += r(
						s), t += '"'), t += "\n    ",
					(l || n) && (t += 'crossorigin="anonymous"'), t += "\n    ", c && (t += 'preload="',
						t += r(c), t += '"'), t +=
					"\n    ", u && (t += 'src="', t += r(u), t += '"'), t += "\n    >\n    ", n && (t +=
						'\n    <track kind="metadata" default src="', t += r(a.url), t +=
						'"></track>\n    '), t += "\n</video>"
			}
		},
		function(e, t, n) {
		...
		function(e, t, n) {
			(function(t) {
				...
				function a(e) {
					...
					this._state = 0, this._handled = !1, this._value = void 0, this._deferreds = [], u(
						e, this)
				}
				...
				function o(e, t) {
					...
					e._handled = !0, a._immediateFn(function() {
						...
						if (null === n) return void(1 === e._state ? s : r)(t.promise, e
							._value);
						var i;
						try {
							i = n(e._value)
				...
				function s(e, t) {
					try {
						...
						if (t && ("object" === (void 0 === t ? "undefined" : d(t)) || "function" ==
								typeof t)) {
							var n = t.then;
				...
				var d = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(
						e) {
						return typeof e
					} : function(e) {
				...
				a.prototype.catch = function(e) {
					...
					return new a(function(t, n) {
						function i(e, s) {
							try {
								if (s && ("object" === (void 0 === s ? "undefined" : d(
										s)) || "function" == typeof s)) {
									var r = s.then;
					...
					return e && "object" === (void 0 === e ? "undefined" : d(e)) && e
						.constructor === a ? e : new a(function(t) {
							t(e)
						})
				}, a.reject = function(e) {
					return new a(function(t, n) {
			...
			(function(e, t) {
				! function(e, n) {
					...
					if (!e.setImmediate) {
						...
						p = p && p.setTimeout ? p : e, "[object process]" === {}.toString.call(e
							.process) ? function() {
							r = function(e) {
								t.nextTick(function() {
									s(e)
							...
							var t = "setImmediate$" + Math.random() + "$",
								n = function(n) {
									n.source === e && "string" == typeof n.data && 0 === n.data
										.indexOf(t) && s(+n.data.slice(t.length))
								};
							e.addEventListener ? e.addEventListener("message", n, !1) : e
								.attachEvent("onmessage", n), r = function(n) {
									e.postMessage(t + n, "*")
								}
							...
							r = function(t) {
								...
								n.onreadystatechange = function() {
									s(t), n.onreadystatechange = null, e.removeChild(n), n =
										null
								}, e.appendChild(n)
							}
						}() : function() {
		...
		function(e, t, n) {
			...
			h.nextTick = function(e) {
				...
				}, h.title = "browser", h.browser = !0, h.env = {}, h.argv = [], h.version = "", h
				.versions = {}, h.on = u, h.addListener =
				u, h.once = u, h.off = u, h.removeListener = u, h.removeAllListeners = u, h.emit = u, h
				.prependListener = u, h.prependOnceListener =
		...
		function(e, t, n) {
			...
			t.default = function(e) {
				var t = {
					container: e.element || document.getElementsByClassName("hjplayer")[0],
					live: !1,
					autoplay: !1,
					theme: "#b7daff",
					loop: !1,
				...
				return e.video && !e.video.type && (e.video.type = "auto"), "object" === i(e.danmaku) &&
					e.danmaku && !e.danmaku
					.user && (e.danmaku.user = "DIYgod"), e.subtitle && (!e.subtitle.type && (e.subtitle
							.type = "webvtt"), !e.subtitle
						.fontSize && (e.subtitle.fontSize = "20px"), !e.subtitle.bottom && (e.subtitle
							.bottom = "40px"), !e.subtitle.color &&
						(e.subtitle.color = "#fff")), e.video.quality && (e.video.url = [e.video
						.quality[e.video.defaultQuality].url
					]),
		...
		function(e, t, n) {
			...
			var i = function(e, t, n, i, a) {
				...
				}, o.open(null !== t ? "POST" : "GET", e, !0), o.send(null !== t ? JSON.stringify(
					t) : null)
			};
			t.default = {
				send: function(e, t, n) {
		...
		function(e, t, n) {
			...
			var o = function() {
				...
				u = function() {
					function e(t) {
						a(this, e), this.container = t.container, this.options = t.options, this.index = t
							.index, this.tran = t.tran,
							this.init()
					}
					return o(e, [{
						key: "init",
						value: function() {
							this.container.innerHTML = (0, c.default)({
									...
									".hjplayer-volume-bar-inner"), this.volumeBarWrap =
								this.container.querySelector(".hjplayer-volume-bar"), this
								.volumeBarWrapWrap = this.container.querySelector(
									".hjplayer-volume-bar-wrap"), this.volumeButton = this
								.container.querySelector(".hjplayer-volume"),
								this.volumeIcon = this.container.querySelector(
									".hjplayer-volume-icon .hjplayer-icon-content"), this
								.playedBar =
								this.container.querySelector(".hjplayer-played"), this
								.loadedBar = this.container.querySelector(
									".hjplayer-loaded"), this.playedBarWrap = this
								.container.querySelector(".hjplayer-bar-wrap"), this
								.playedBarTime =
								this.container.querySelector(".hjplayer-bar-time"), this
								.danmaku = this.container.querySelector(
									".hjplayer-danmaku"), this.danmakuLoading = this
								.container.querySelector(".hjplayer-danloading"),
								this.video = this.container.querySelector(
									".hjplayer-video-current"), this.bezel = this.container
								.querySelector(
									".hjplayer-bezel-icon"), this.playButton = this
								.container.querySelector(".hjplayer-play-icon"), this
								.videoWrap =
								this.container.querySelector(".hjplayer-video-wrap"), this
								.controllerMask = this.container.querySelector(
									".hjplayer-controller-mask"), this.ptime = this
								.container.querySelector(".hjplayer-ptime"), this
								.settingButton =
								this.container.querySelector(".hjplayer-setting-icon"),
								this.settingBox = this.container.querySelector(
									".hjplayer-setting-box"), this.mask = this.container
								.querySelector(".hjplayer-mask"), this.loop =
								this.container.querySelector(".hjplayer-setting-loop"),
								this.loopToggle = this.container.querySelector(
									...
									".hjplayer-setting-showdan"), this.showDanmakuToggle =
								this.container.querySelector(
									".hjplayer-showdan-setting-input"), this
								.unlimitDanmaku = this.container.querySelector(
									".hjplayer-setting-danunlimit"), this
								.unlimitDanmakuToggle = this.container.querySelector(
									".hjplayer-danunlimit-setting-input"), this.speed =
								this.container.querySelector(
									".hjplayer-setting-speed"), this.speedItem = this
								.container.querySelectorAll(
									".hjplayer-setting-speed-item"), this
								.danmakuOpacityBar = this.container.querySelector(
									".hjplayer-danmaku-bar-inner"), this
								.danmakuOpacityBarWrap = this.container.querySelector(
									".hjplayer-danmaku-bar"), this
								.danmakuOpacityBarWrapWrap = this.container.querySelector(
									".hjplayer-danmaku-bar-wrap"), this.danmakuOpacityBox =
								this.container.querySelector(
									".hjplayer-setting-danmaku"), this.dtime = this
								.container.querySelector(".hjplayer-dtime"), this
								.controller =
								this.container.querySelector(".hjplayer-controller"), this
								.commentInput = this.container.querySelector(
									".hjplayer-comment-input"), this.commentButton = this
								.container.querySelector(
									".hjplayer-comment-icon"), this.yzmcomment = this
								.container.querySelector(
									".hj-hjplayer-comment-input"), this
								.commentSettingBox = this.container.querySelector(
									".hjplayer-comment-setting-box"), this
								.commentSettingButton = this.container.querySelector(
									".hjplayer-comment-setting-icon"), this
								.commentSettingFill = this.container.querySelector(
									".hjplayer-comment-setting-icon path"), this
								.commentSendButton = this.container.querySelector(
									".hjplayer-send-icon"), this.commentSendFill = this
								.container.querySelector(
									".hjplayer-send-icon path"), this
								.commentColorSettingBox = this.container.querySelector(
									".hjplayer-comment-setting-color"), this
								.browserFullButton = this.container.querySelector(
									".hjplayer-full-icon"), this.webFullButton = this
								.container.querySelector(".hjplayer-full-in-icon"),
								this.menu = this.container.querySelector(".hjplayer-menu"),
								this.menuItem = this.container.querySelectorAll(
									".hjplayer-menu-item"), this.qualityList = this
								.container.querySelector(".hjplayer-quality-list"),
								this.camareButton = this.container.querySelector(
									".hjplayer-camera-icon"), this.subtitleButton = this
								.container
								.querySelector(".hjplayer-subtitle-icon"), this
								.subtitleButtonInner = this.container.querySelector(
									".hjplayer-subtitle-icon .hjplayer-icon-content"),
								this.subtitle = this.container.querySelector(
									".hjplayer-subtitle"), this.qualityButton = this
								.container.querySelector(".hjplayer-quality-icon"),
								this.barPreview = this.container.querySelector(
									".hjplayer-bar-preview"), this.barWrap = this.container
								.querySelector(
									".hjplayer-bar-wrap"), this.notice = this.container
								.querySelector(".hjplayer-notice"), this.infoPanel =
								this.container.querySelector(".hjplayer-info-panel"), this
								.infoPanelClose = this.container.querySelector(
									".hjplayer-info-panel-close"), this.infoVersion = this
								.container.querySelector(
								...
								), this.infoResolution = this.container
								.querySelector(
		...
		function(e, t, n) {
			...
			e.exports = function(e) {
				...
				return t +=
					...
					o.danmaku && (t += '\n        <span class="hjplayer-danloading">', t += s(r(
							"Danmaku is loading")), t +=
					...
					.video.quality && (t +=
						...
						u(o.video.quality, function(e, n) {
							t += '\n                    <div class="hjplayer-quality-item" data-index="',
								t += s(n), t += '">', t += s(
									e.name), t += "</div>\n                "
						}), t +=
						"\n                </div>\n            </div>\n        </div>\n        "), t +=
					...
					t += s(c), t += '" value="bottom">\n                    <span>', t += s(r(
						"Bottom")), t +=
					'</span>\n                </label>\n            </div>\n    <div class="hjplayer-comment-setting-font"><div class="hjplayer-comment-setting-title">弹幕大小</div><label><input type="radio"name="hjplayer-danmaku-font-0"value="50px"><span>超大</span></label><label><input type="radio"name="hjplayer-danmaku-font-0"value="35px"><span>较大</span></label><label><input type="radio"name="hjplayer-danmaku-font-0"value="27.5px"checked=""><span>标准</span></label><label><input type="radio"name="hjplayer-danmaku-font-0"value="18px"><span>较小</span></label></div>      <div class="hjplayer-comment-setting-color">\n                <div class="hjplayer-comment-setting-title">',
					t += s(r("Set danmaku color")), t +=
					'</div>\n                <label>\n                    <input type="radio" name="hjplayer-danmaku-color-',
					t +=
					s(c), t +=
					...
					t += s(c), t +=
					'" value="#FFFFFF" checked>\n                    <span style="background: #FFFFFF"></span>\n                </label>\n</div>\n                   </div>\n        <input class="hjplayer-comment-input" type="text" placeholder="',
					t += s(r("Input danmaku, hit Enter")), t +=
					'" maxlength="30">\n        <button class="hjplayer-icon hjplayer-send-icon" data-balloon="',
					t += s(r(
						"Send")), t +=
					'" data-balloon-pos="up">\n            <span class="hjplayer-icon-content">', t +=
					l.send, t +=
					'</span>\n        </button>\n<input id="dmtext" dmtype="right" size="27.5px" class="hj-hjplayer-comment-input" type="text" placeholder="',
					t += s(r("Input danmaku, hit Enter")), t +=
					'" maxlength="30" >\n        <button class="hjplayer-icon hj-hjplayer-send-icon" data-balloon="',
					t += s(r(
						"Send")), t +=
